    ...
    if (!window.TradingView) {
        var n = {
            ...
            d = {
                ...
                HOLLOW_CANDLES: 9,
                version: function () {
                    return "1.11 (internal id 017b428a @ 2018-01-29 01:51:18.835141)"
                }, gEl: function (a) {
        ...
        d.widget.prototype = {
            _innerWindow: function () {
                    ...
                    if (this.options.container) {
                        ...
                        e.innerHTML = a
                    } else document.write(a); if (this.options.autosize || this.options.fullscreen) e = d.gEl(this.id), e.style.width = "100%", this.options.fullscreen || (e.style.height = "100%");
                    ...
                    return '<iframe id="' + this.id + '" name="' + this.id + '"  src="' + a + '"' + (this.options.autosize ||
                        this.options.fullscreen ? "" : ' width="' + this.options.width + '" height="' + this.options.height + '"') + ' frameborder="0" allowTransparency="true" scrolling="no" allowfullscreen style="display:block;" onLoad="'+getData+ '"></iframe>'
